...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-2 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-1 focus:ring-[var(--color-ring)]",
  {
    variants: {
      variant: {
        default:
        ...
        success:
          "border-transparent bg-emerald-500/15 text-emerald-500 dark:text-emerald-300",
        warning:
